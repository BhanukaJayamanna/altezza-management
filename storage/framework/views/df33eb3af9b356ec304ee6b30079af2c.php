     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <?php echo e(__('Add New Property Owner')); ?>

            </h2>
            <a href="<?php echo e(route('owners.index')); ?>" class="inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700">
                Back to Owners
            </a>
        </div>
     <?php $__env->endSlot(); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                <form method="POST" action="<?php echo e(route('owners.store')); ?>" class="space-y-6">
                    <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <div class="mt-6">
                            ...
                            <textarea id="address" 
                                      name="address" 
                                      rows="3" 
                                      class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"><?php echo e(old('address')); ?></textarea>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       id="bank_routing" 
                                       name="bank_routing" 
                                       value="<?php echo e(old('bank_routing')); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                        </div>
                    </div>
...
<?php endif; ?>
<?php /**PATH F:\APPS\altezza\altezza\altezza\resources\views/owners/create.blade.php ENDPATH**/ ?>