...
<div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gradient-to-br from-slate-50 to-blue-50">
    ...
    <div class="hidden lg:flex lg:flex-shrink-0">
        <div class="flex flex-col w-72 bg-white shadow-xl border-r border-slate-200">
            <?php echo $__env->make('layouts.sidebar-content', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
    </div>
            ...
            <div class="ml-4 flex items-center md:ml-6">
                ...
                <div class="relative" x-data="{ notificationOpen: false }">
                    <button x-on:click="notificationOpen = !notificationOpen" 
                            type="button" 
                            class="bg-slate-50 p-2 rounded-lg text-slate-500 hover:text-slate-700 hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200 relative">
                        ...
                        <!-- Notification badge -->
                        <span data-notification-badge class="absolute -top-1 -right-1 h-4 w-4 bg-red-500 rounded-full flex items-center justify-center" style="display: none;">
                    ...
                    <div x-show="notificationOpen" 
                         x-on:click.away="notificationOpen = false" 
                         ...
                         class="origin-top-right absolute right-0 mt-2 w-96 rounded-xl shadow-lg bg-white ring-1 ring-slate-200 focus:outline-none z-50 border border-slate-100 max-h-96 overflow-hidden"
                         style="display: none;">
                        ...
                        <div class="px-4 py-3 border-b border-slate-100 bg-slate-50">
                            <div class="flex items-center justify-between">
                                ...
                                <button data-mark-all-read class="text-xs text-blue-600 hover:text-blue-800 font-medium">
                                    Mark all as read
                                </button>
                            </div>
                        </div>
                    ...
                    <div>
                        <button x-on:click="profileOpen = !profileOpen" 
                            ...
                            <div class="hidden lg:block ml-3 text-left">
                                <div class="text-slate-700 text-sm font-medium"><?php echo e(Auth::user()->name); ?></div>
                                <div class="text-slate-500 text-xs capitalize"><?php echo e(Auth::user()->role); ?></div>
                            </div>
                        ...
                        <div class="py-2">
                            <div class="px-4 py-3 border-b border-slate-100">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-3">
                                        <div class="text-sm font-medium text-slate-900"><?php echo e(Auth::user()->name); ?></div>
                                        <div class="text-xs text-slate-500 capitalize"><?php echo e(Auth::user()->role); ?></div>
                                    </div>
                                </div>
                            </div>
                            <a href="<?php echo e(route('profile.edit')); ?>" class="flex items-center px-4 py-3 text-sm text-slate-700 hover:bg-slate-50 transition-colors duration-200">
...
<?php /**PATH F:\APPS\altezza\altezza\altezza\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>