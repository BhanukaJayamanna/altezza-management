<div <?php echo e($attributes); ?>>
    <div class="flex items-center space-x-3">
        <!-- Building Icon/Logo -->
        <div class="relative">
            <svg class="w-12 h-12 text-blue-600" viewBox="0 0 100 100" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="flex flex-col">
            <span class="text-2xl font-bold text-white tracking-tight">ALTEZZA</span>
            <span class="text-sm font-medium text-white/80 -mt-1">Property Management</span>
        </div>
    </div>
</div>
<?php /**PATH F:\APPS\altezza\altezza\altezza\resources\views/components/altezza-logo.blade.php ENDPATH**/ ?>