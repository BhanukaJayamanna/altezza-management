    ...
    <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
        ...
        <div class="pt-6">
            ...
            <a href="<?php echo e(route('owners.index')); ?>" class="group flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('owners.*') ? 'bg-gradient-to-r from-purple-50 to-indigo-50 text-purple-700 shadow-sm border border-purple-100' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900'); ?>">
                <div class="mr-3 h-8 w-8 <?php echo e(request()->routeIs('owners.*') ? 'bg-purple-100 text-purple-600' : 'bg-slate-100 text-slate-400 group-hover:bg-slate-200 group-hover:text-slate-600'); ?> rounded-lg flex items-center justify-center transition-all duration-200">
                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('management-corporations.index')); ?>" class="group flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('management-corporations.*') ? 'bg-gradient-to-r from-emerald-50 to-green-50 text-emerald-700 shadow-sm border border-emerald-100' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900'); ?>">
                <div class="mr-3 h-8 w-8 <?php echo e(request()->routeIs('management-corporations.*') ? 'bg-emerald-100 text-emerald-600' : 'bg-slate-100 text-slate-400 group-hover:bg-slate-200 group-hover:text-slate-600'); ?> rounded-lg flex items-center justify-center transition-all duration-200">
                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                    </svg>
                </div>
        ...
        <div class="pt-6">
            ...
            <?php else: ?>
                <a href="<?php echo e(route('owner.invoices')); ?>" class="group flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('owner.invoices*') ? 'bg-gradient-to-r from-green-50 to-emerald-50 text-green-700 shadow-sm border border-green-100' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900'); ?>">
                    <div class="mr-3 h-8 w-8 <?php echo e(request()->routeIs('owner.invoices*') ? 'bg-green-100 text-green-600' : 'bg-slate-100 text-slate-400 group-hover:bg-slate-200 group-hover:text-slate-600'); ?> rounded-lg flex items-center justify-center transition-all duration-200">
                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 14l6-6m-5.5.5h.01m4.99 5h.01M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16l3.5-2 3.5 2 3.5-2 3.5 2zM10 8.5a.5.5 0 11-1 0 .5.5 0 011 0zm5 5a.5.5 0 11-1 0 .5.5 0 011 0z"></path>
                        </svg>
                    </div>
            ...
            <?php else: ?>
                <a href="<?php echo e(route('owner.payments')); ?>" class="group flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('owner.payments*') ? 'bg-gradient-to-r from-blue-50 to-cyan-50 text-blue-700 shadow-sm border border-blue-100' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900'); ?>">
                    <div class="mr-3 h-8 w-8 <?php echo e(request()->routeIs('owner.payments*') ? 'bg-blue-100 text-blue-600' : 'bg-slate-100 text-slate-400 group-hover:bg-slate-200 group-hover:text-slate-600'); ?> rounded-lg flex items-center justify-center transition-all duration-200">
                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"></path>
                        </svg>
                    </div>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage_invoices')): ?>
                <a href="<?php echo e(route('rooftop-reservations.index')); ?>" class="group flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('rooftop-reservations.*') ? 'bg-gradient-to-r from-sky-50 to-cyan-50 text-sky-700 shadow-sm border border-sky-100' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900'); ?>">
                    <div class="mr-3 h-8 w-8 <?php echo e(request()->routeIs('rooftop-reservations.*') ? 'bg-sky-100 text-sky-600' : 'bg-slate-100 text-slate-400 group-hover:bg-slate-200 group-hover:text-slate-600'); ?> rounded-lg flex items-center justify-center transition-all duration-200">
                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Management Fees -->
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage_invoices')): ?>
                <a href="<?php echo e(route('management-fees.index')); ?>" class="group flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('management-fees.*') ? 'bg-gradient-to-r from-yellow-50 to-orange-50 text-yellow-700 shadow-sm border border-yellow-100' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900'); ?>">
                    <div class="mr-3 h-8 w-8 <?php echo e(request()->routeIs('management-fees.*') ? 'bg-yellow-100 text-yellow-600' : 'bg-slate-100 text-slate-400 group-hover:bg-slate-200 group-hover:text-slate-600'); ?> rounded-lg flex items-center justify-center transition-all duration-200">
                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <?php else: ?>
                <!-- Owner Utility Bills -->
                <a href="<?php echo e(route('owner.utility-bills')); ?>" class="group flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('owner.utility-bills*') ? 'bg-gradient-to-r from-orange-50 to-amber-50 text-orange-700 shadow-sm border border-orange-100' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900'); ?>">
                    <div class="mr-3 h-8 w-8 <?php echo e(request()->routeIs('owner.utility-bills*') ? 'bg-orange-100 text-orange-600' : 'bg-slate-100 text-slate-400 group-hover:bg-slate-200 group-hover:text-slate-600'); ?> rounded-lg flex items-center justify-center transition-all duration-200">
                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path>
                        </svg>
                    </div>
        ...
        <div class="flex-shrink-0 w-full group block">
            <div class="flex items-center">
                <div class="h-10 w-10 rounded-xl bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white font-semibold shadow-lg">
                    <?php echo e(substr(Auth::user()?->name ?? 'Guest', 0, 1)); ?>

                </div>
                <div class="ml-3 flex-1">
                    <p class="text-sm font-semibold text-slate-700 group-hover:text-slate-900"><?php echo e(Auth::user()?->name ?? 'Guest'); ?></p>
                    <p class="text-xs font-medium text-slate-500 group-hover:text-slate-700 capitalize"><?php echo e(Auth::user()?->role ?? 'guest'); ?></p>
                </div>
                <div class="ml-2">
