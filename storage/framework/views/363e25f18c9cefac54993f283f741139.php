                            ...
                            <div>
                                <button x-on:click="profileOpen = !profileOpen" 
                                    ...
                                    <div class="hidden lg:block ml-3 text-left">
                                        <div class="text-slate-700 text-sm font-medium"><?php echo e(Auth::user()?->name ?? 'Guest'); ?></div>
                                        <div class="text-slate-500 text-xs capitalize"><?php echo e(Auth::user()?->role ?? 'guest'); ?></div>
                                    </div>
                                ...
                                <div class="py-2">
                                    <div class="px-4 py-3 border-b border-slate-100">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-3">
                                                <div class="text-sm font-medium text-slate-900"><?php echo e(Auth::user()?->name ?? 'Guest'); ?></div>
                                                <div class="text-xs text-slate-500 capitalize"><?php echo e(Auth::user()?->role ?? 'guest'); ?></div>
                                            </div>
                                        </div>
                                    </div>
...
<?php /**PATH F:\APPS\altezza\altezza\altezza\resources\views/components/app-layout.blade.php ENDPATH**/ ?>