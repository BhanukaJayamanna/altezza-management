     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <?php echo e(__('Add New Utility Meter')); ?>
...
<?php $component->withAttributes([]); ?>
                ...
                <form method="POST" action="<?php echo e(route('utility-meters.store')); ?>" class="p-6 space-y-6">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="type" name="type" required
                                ...
                                <option value="electricity" <?php echo e(old('type') == 'electricity' ? 'selected' : ''); ?>>Electricity</option>
                                <option value="water" <?php echo e(old('type') == 'water' ? 'selected' : ''); ?>>Water</option>
                                <option value="gas" <?php echo e(old('type') == 'gas' ? 'selected' : ''); ?>>Gas</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="meter_number" name="meter_number" value="<?php echo e(old('meter_number')); ?>" required
                                   class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        ...
                        <div>
                            ...
                            <input type="number" id="last_reading" name="last_reading" value="<?php echo e(old('last_reading')); ?>" 
                                   step="0.01" min="0"
                                   class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                   placeholder="0.00">
                        ...
                        <div>
                            ...
                            <input type="date" id="last_reading_date" name="last_reading_date" value="<?php echo e(old('last_reading_date')); ?>"
                                   class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        </div>
                        ...
                        <div>
                            ...
                            <select id="status" name="status" required
                                ...
                                <option value="faulty" <?php echo e(old('status') == 'faulty' ? 'selected' : ''); ?>>Faulty</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="notes" name="notes" rows="3"
                                  class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                  placeholder="Any additional notes about this meter..."><?php echo e(old('notes')); ?></textarea>
                    </div>

                    <!-- Form Actions -->
                    <div class="flex justify-end space-x-4 pt-6 border-t">
                        <a href="<?php echo e(route('utility-meters.index')); ?>" 
...
<?php endif; ?>
<?php /**PATH F:\APPS\altezza\altezza\altezza\resources\views/utilities/meters/create.blade.php ENDPATH**/ ?>