     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <?php echo e(__('Edit Tenant')); ?> - <?php echo e($tenant->name); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                <form method="POST" action="<?php echo e(route('tenants.update', $tenant)); ?>" class="space-y-6">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       id="id_document" 
                                       name="id_document" 
                                       value="<?php echo e(old('id_document', $tenant->tenantProfile?->id_document ?? '')); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <select id="apartment_id" 
                                    ...
                                    <?php $__currentLoopData = $availableApartments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $apartment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($apartment->id); ?>" 
                                                <?php echo e(old('apartment_id', $tenant->tenantProfile?->apartment_id ?? '') == $apartment->id ? 'selected' : ''); ?>>
                            ...
                            <div>
                                ...
                                <select id="status" 
                                        ...
                                        required
                                        class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                    <option value="active" <?php echo e(old('status', $tenant->tenantProfile?->status ?? 'active') == 'active' ? 'selected' : ''); ?>>Active</option>
                                    <option value="inactive" <?php echo e(old('status', $tenant->tenantProfile?->status ?? '') == 'inactive' ? 'selected' : ''); ?>>Inactive</option>
                                    <option value="moved_out" <?php echo e(old('status', $tenant->tenantProfile?->status ?? '') == 'moved_out' ? 'selected' : ''); ?>>Moved Out</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="date" 
                                       id="lease_start" 
                                       name="lease_start" 
                                       value="<?php echo e(old('lease_start', $tenant->tenantProfile?->lease_start?->format('Y-m-d') ?? '')); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="date" 
                                       id="lease_end" 
                                       name="lease_end" 
                                       value="<?php echo e(old('lease_end', $tenant->tenantProfile?->lease_end?->format('Y-m-d') ?? '')); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       value="<?php echo e(old('emergency_contact_name', $tenant->tenantProfile?->emergency_contact ?? '')); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="tel" 
                                       ...
                                       value="<?php echo e(old('emergency_contact_phone', $tenant->tenantProfile?->emergency_phone ?? '')); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border-t pt-6">
                        ...
                        <div>
                            ...
                            <textarea id="notes" 
                                      name="notes" 
                                      rows="4" 
                                      class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"><?php echo e(old('notes', $tenant->tenantProfile?->notes ?? '')); ?></textarea>
                        </div>
                    </div>
...
<?php endif; ?>
<?php /**PATH F:\APPS\altezza\altezza\altezza\resources\views/tenants/edit.blade.php ENDPATH**/ ?>