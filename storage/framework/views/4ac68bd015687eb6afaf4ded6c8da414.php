        ...
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold bg-gradient-to-r from-slate-900 to-slate-700 bg-clip-text text-transparent">
                    <?php echo e(__('Management Fee Settings')); ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div class="lg:col-span-2">
            <div class="bg-white rounded-lg shadow-md">
                ...
                <form method="POST" action="<?php echo e(route('management-fees.update-settings')); ?>" class="p-6">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            <input type="number" 
                                   ...
                                   min="0"
                                   max="999.99"
                                   value="<?php echo e(old('management_fee_ratio', $settings['management_fee_ratio'])); ?>"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                   required>
                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                <span class="text-gray-500 sm:text-sm"><?php echo e($settings['currency_symbol']); ?></span>
                            </div>
                        </div>
                        <p class="mt-1 text-sm text-gray-500">
                            Current rate: <?php echo e($settings['currency_symbol']); ?><?php echo e($settings['management_fee_ratio']); ?> per sqft/month
                        </p>
                        <?php $__errorArgs = ['management_fee_ratio'];
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            <input type="number" 
                                   ...
                                   min="0"
                                   max="999.99"
                                   value="<?php echo e(old('sinking_fund_ratio', $settings['sinking_fund_ratio'])); ?>"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                   required>
                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                <span class="text-gray-500 sm:text-sm"><?php echo e($settings['currency_symbol']); ?></span>
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            Current rate: <?php echo e($settings['currency_symbol']); ?><?php echo e($settings['sinking_fund_ratio']); ?> per sqft/month
                        </p>
                        <?php $__errorArgs = ['sinking_fund_ratio'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" 
                               ...
                               min="1"
                               max="365"
                               value="<?php echo e(old('due_days', $settings['due_days'])); ?>"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                               required>
                        <p class="mt-1 text-sm text-gray-500">
                            Number of days after invoice generation when payment is due
                        </p>
                        <?php $__errorArgs = ['due_days'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            <input type="number" 
                                   ...
                                   min="0"
                                   max="100"
                                   value="<?php echo e(old('late_fee_percentage', $settings['late_fee_percentage'])); ?>"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                   required>
                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                        ...
                        <?php $__errorArgs = ['late_fee_percentage'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                    ...
                    <div class="mb-6">
                        <div class="flex items-center">
                            <input type="checkbox" 
                                   ...
                                   name="auto_generate"
                                   value="1"
                                   <?php echo e(old('auto_generate', $settings['auto_generate']) ? 'checked' : ''); ?>
                        ...
                        <div>
                            ...
                            <div class="space-y-2 text-sm">
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-medium">1000 × <?php echo e($settings['management_fee_ratio']); ?> = <?php echo e($settings['currency_symbol']); ?><?php echo e(number_format(1000 * $settings['management_fee_ratio'], 2)); ?></span>
                                </div>
                                
                                <div class="flex justify-between">
                                    <span class="text-gray-600">Sinking Fund (Monthly):</span>
                                    <span class="font-medium">1000 × <?php echo e($settings['sinking_fund_ratio']); ?> = <?php echo e($settings['currency_symbol']); ?><?php echo e(number_format(1000 * $settings['sinking_fund_ratio'], 2)); ?></span>
                                </div>
                                
                                <div class="border-t pt-2">
                                    <div class="flex justify-between font-semibold">
                                        <span class="text-gray-900">Quarterly Total:</span>
                                        <span class="text-blue-600"><?php echo e($settings['currency_symbol']); ?><?php echo e(number_format((1000 * $settings['management_fee_ratio'] + 1000 * $settings['sinking_fund_ratio']) * 3, 2)); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updatePreview() {
        ...
        document.querySelector('.preview-management').textContent = 
            `1000 × ${managementRatio.toFixed(2)} = <?php echo e($settings['currency_symbol']); ?>${monthlyManagement.toFixed(2)}`;
        document.querySelector('.preview-sinking').textContent = 
            `1000 × ${sinkingRatio.toFixed(2)} = <?php echo e($settings['currency_symbol']); ?>${monthlySinking.toFixed(2)}`;
        document.querySelector('.preview-total').textContent = 
            `<?php echo e($settings['currency_symbol']); ?>${quarterlyTotal.toFixed(2)}`;
    }
...
<?php endif; ?>
<?php /**PATH F:\APPS\altezza\altezza\altezza\resources\views/management-fees/settings.blade.php ENDPATH**/ ?>