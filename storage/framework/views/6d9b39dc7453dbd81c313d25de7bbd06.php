...
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('owners.create')).'']); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('owners.index')).'','variant' => 'secondary']); ?>
                                    Clear
                                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561)): ?>
...
<?php $component->withAttributes([]); ?>
                <div class="px-6 py-4 border-b border-gray-200">
                    <h3 class="text-lg font-semibold text-gray-900">All Owners (<?php echo e($owners->total()); ?>)</h3>
                </div>
                <div class="overflow-hidden">
                    <?php if($owners->count() > 0): ?>
                                        ...
                                        <tr class="hover:bg-gradient-to-r hover:from-gray-50 hover:to-blue-50 transition-all duration-200">
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex items-center">
                                                    ...
                                                    <div class="ml-4">
                                                        <div class="text-sm font-semibold text-gray-900"><?php echo e($owner->name); ?></div>
                                                        <div class="text-xs text-gray-500">ID: #<?php echo e($owner->id); ?></div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm text-gray-900"><?php echo e($owner->email); ?></div>
                                                <?php if($owner->phone): ?>
                                                    <div class="text-sm text-gray-500"><?php echo e($owner->phone); ?></div>
                                                <?php endif; ?>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <div class="px-6 py-4 border-t border-gray-200">
                            <?php echo e($owners->appends(request()->query())->links()); ?>
...
<?php endif; ?>
<?php /**PATH F:\APPS\altezza\altezza\altezza\resources\views/owners/index.blade.php ENDPATH**/ ?>