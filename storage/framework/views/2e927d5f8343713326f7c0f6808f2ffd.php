     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <?php echo e(__('Add New Unit Price')); ?>
...
<?php $component->withAttributes([]); ?>
                ...
                <form method="POST" action="<?php echo e(route('utility-unit-prices.store')); ?>" class="p-6 space-y-6">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="type" name="type" required
                                ...
                                <option value="electricity" <?php echo e(old('type') == 'electricity' ? 'selected' : ''); ?>>Electricity (per kWh)</option>
                                <option value="water" <?php echo e(old('type') == 'water' ? 'selected' : ''); ?>>Water (per gallon)</option>
                                <option value="gas" <?php echo e(old('type') == 'gas' ? 'selected' : ''); ?>>Gas (per cubic foot)</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="price_per_unit" name="price_per_unit" value="<?php echo e(old('price_per_unit')); ?>" 
                        ...
                        <div>
                            ...
                            <input type="date" id="effective_from" name="effective_from" value="<?php echo e(old('effective_from', now()->format('Y-m-d'))); ?>" required
                                   class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="date" id="effective_to" name="effective_to" value="<?php echo e(old('effective_to')); ?>"
                                   class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="3"
                                  class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                  placeholder="Any notes about this pricing change..."><?php echo e(old('description')); ?></textarea>
                    </div>
...
<?php endif; ?>
<?php /**PATH F:\APPS\altezza\altezza\altezza\resources\views/utilities/unit-prices/create.blade.php ENDPATH**/ ?>