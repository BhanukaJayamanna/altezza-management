                    ...
                    <div class="p-6 bg-white border-b border-gray-200">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900"><?php echo e($stats['total_apartments']); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6 bg-white border-b border-gray-200">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900"><?php echo e($stats['occupied_apartments']); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6 bg-white border-b border-gray-200">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900"><?php echo e($stats['vacant_apartments']); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <?php if($recentActivities['recent_maintenance']->isNotEmpty()): ?>
                            <div class="space-y-3">
                                <?php $__currentLoopData = $recentActivities['recent_maintenance']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <p class="text-sm font-medium text-gray-900 truncate">
                                                <?php echo e($request->apartment->full_address ?? 'N/A'); ?>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <?php if($recentActivities['recent_complaints']->isNotEmpty()): ?>
                            <div class="space-y-3">
                                <?php $__currentLoopData = $recentActivities['recent_complaints']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $complaint): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center space-x-3">
                                        <div class="flex-shrink-0">
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium 
                                                <?php if($complaint->status === 'open'): ?> bg-red-100 text-red-800
                                                <?php elseif($complaint->status === 'in_review'): ?> bg-yellow-100 text-yellow-800
                                                <?php elseif($complaint->status === 'resolved'): ?> bg-green-100 text-green-800
                                                <?php else: ?> bg-gray-100 text-gray-800 <?php endif; ?>">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <p class="text-sm font-medium text-gray-900 truncate">
                                                <?php echo e($complaint->apartment->full_address ?? 'N/A'); ?>
...
<?php endif; ?>
<?php /**PATH F:\APPS\altezza\altezza\altezza\resources\views/dashboard/admin.blade.php ENDPATH**/ ?>