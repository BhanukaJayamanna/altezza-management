     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <?php echo e(__('Management Corporations')); ?>

            </h2>
            <?php if (isset($component)) { $__componentOriginald0f1fd2689e4bb7060122a5b91fe8561 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['href' => ''.e(route('management-corporations.create')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('management-corporations.create')).'']); ?>
...
<?php $component->withAttributes([]); ?>
                <div class="p-6">
                    <form method="GET" action="<?php echo e(route('management-corporations.index')); ?>" class="flex flex-wrap gap-4">
...
<?php endif; ?>
                            <?php if(request()->hasAny(['search', 'status'])): ?>
                                <?php if (isset($component)) { $__componentOriginald0f1fd2689e4bb7060122a5b91fe8561 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['href' => ''.e(route('management-corporations.index')).'','variant' => 'secondary']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('management-corporations.index')).'','variant' => 'secondary']); ?>
                                    Clear
                                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561)): ?>
...
<?php $component->withAttributes([]); ?>
                <div class="px-6 py-4 border-b border-gray-200">
                    <h3 class="text-lg font-semibold text-gray-900">All Management Corporations (<?php echo e($managementCorporations->total()); ?>)</h3>
                </div>
                <div class="overflow-hidden">
                    <?php if($managementCorporations->count() > 0): ?>
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-100">
                                    <?php $__currentLoopData = $managementCorporations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $managementCorporation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="hover:bg-gradient-to-r hover:from-gray-50 hover:to-blue-50 transition-all duration-200">
                                                    ...
                                                    <div class="flex-shrink-0 h-12 w-12">
                                                        <div class="h-12 w-12 rounded-xl bg-gradient-to-br from-indigo-400 to-blue-500 flex items-center justify-center shadow-lg">
                                                            <span class="text-sm font-bold text-white">
                                                                <?php echo e(strtoupper(substr($managementCorporation->name, 0, 2))); ?>

                                                            </span>
                                                        </div>
                                                    </div>
                                                    <div class="ml-4">
                                                        <div class="text-sm font-semibold text-gray-900"><?php echo e($managementCorporation->name); ?></div>
                                                        <div class="text-xs text-gray-500">ID: #<?php echo e($managementCorporation->id); ?></div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm text-gray-900"><?php echo e($managementCorporation->email); ?></div>
                                                <?php if($managementCorporation->phone): ?>
                                                    <div class="text-sm text-gray-500"><?php echo e($managementCorporation->phone); ?></div>
                                                <?php endif; ?>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex space-x-3">
                                                    <div class="text-center">
                                                        <div class="text-sm font-semibold text-gray-900"><?php echo e($managementCorporation->apartments_count); ?></div>
                                                        <div class="text-xs text-gray-500">Total</div>
                                                    </div>
                                                    <div class="text-center">
                                                        <div class="text-sm font-semibold text-green-600"><?php echo e($managementCorporation->occupied_apartments_count); ?></div>
                                                        <div class="text-xs text-gray-500">Occupied</div>
                                                    </div>
                                                    <div class="text-center">
                                                        <div class="text-sm font-semibold text-blue-600"><?php echo e($managementCorporation->apartments_count - $managementCorporation->occupied_apartments_count); ?></div>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <div class="flex justify-end space-x-2">
                                                    <a href="<?php echo e(route('management-corporations.show', $managementCorporation)); ?>" 
                        ...
                        <div class="px-6 py-4 border-t border-gray-200">
                            <?php echo e($managementCorporations->appends(request()->query())->links()); ?>
...
<?php endif; ?>
<?php /**PATH F:\APPS\altezza\altezza\altezza\resources\views/management-corporations/index.blade.php ENDPATH**/ ?>