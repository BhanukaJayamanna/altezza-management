                                    ...
                                    <div class="p-6 pb-4 pr-24">
                                        <div class="flex items-start justify-between mb-4">
                                            <div>
                                                ...
                                                @if($apartment->block)
                                                    <p class="text-sm text-gray-500 mt-1">Block {{ $apartment->block }}</p>
                                                @endif
                                            </div>
                                        </div>
                                    ...
                                    <div class="px-6 py-4 bg-gray-50 border-t border-gray-100">
                                        <div class="space-y-2">
                                            ...
                                            <div class="flex items-center text-sm">
                                                ...
                                                <span class="ml-1 font-medium text-gray-900">{{ $apartment->owner->name ?? 'N/A' }}</span>
                                            </div>
                                            ...
                                            @if($apartment->tenant)
                                                <div class="flex items-center text-sm">
                                                    ...
                                                    <span class="ml-1 font-medium text-gray-900">{{ $apartment->tenant->name }}</span>
                                                </div>
                                            @endif
                                        </div>
                                    </div>
