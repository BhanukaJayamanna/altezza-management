<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <x-card>
                <div class="p-6">
                    <form method="POST" action="{{ route('vouchers.store') }}" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        ...
                        <div class="border-b border-gray-200 pb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="date" name="voucher_date" id="voucher_date" value="{{ old('voucher_date', date('Y-m-d')) }}" 
                                ...
                                <div>
                                    ...
                                    <select name="expense_category" id="expense_category" 
                                        ...
                                        @foreach($categories as $key => $label)
                                            <option value="{{ $key }}" {{ old('expense_category') == $key ? 'selected' : '' }}>{{ $label }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="border-b border-gray-200 pb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="email" name="vendor_email" id="vendor_email" value="{{ old('vendor_email') }}" 
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="vendor_address" id="vendor_address" rows="3" 
                                              ...
                                              placeholder="Enter vendor address">{{ old('vendor_address') }}</textarea>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="vendor_nic" id="vendor_nic" 
                                           ...
                                           placeholder="Enter NIC or Business Registration number" value="{{ old('vendor_nic') }}">
                                    @error('vendor_nic')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <textarea name="description" id="description" rows="4" 
                                              ...
                                              placeholder="Describe the purpose of this payment..." required>{{ old('description') }}</textarea>
                                    @error('description')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
