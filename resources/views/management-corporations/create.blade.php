<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Add New Management Corporation') }}
            </h2>
            <a href="{{ route('management-corporations.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700">
    ...
    <div class="py-12">
        <div class="w-full mx-auto sm:px-6 lg:px-8">
            ...
            <x-card>
                <form method="POST" action="{{ route('management-corporations.store') }}" class="space-y-6">
                    @csrf
